 ...
 */
package com.espe.distribuidas.eBanking.persistence;
...
//    private static PersistenceManager managerSingleton;
    ...
    static {
        ...
        morphia = new Morphia();
        morphia.mapPackage("com.espe.distribuidas.eBanking.modelo", true);
        
    }

    public PersistenceManager() {
        mds = morphia.createDatastore(mongoClient, "ebanking");
        mds.ensureIndexes();
    }
